...
SAVE_CKPT_FOLDER = "local:llm_ckpts_no_ep"
...
ckpt = dict(
    ...
    # generate_meta_data=dict(enable=True, path='./'),
)

TRAIN_FOLDER = "/datapool/old_datapool/share/daoxin/merge_data/group_1/train" # "/path/to/dataset"
# TRAIN_FOLDER = "/workspace/RedPajama-Data-1T-Sample/" # "/path/to/dataset"
# TRAIN_FOLDER = None
TRAIN_FOLDER = "/datapool/caikun/datasets/internlm/1"
...
data = dict(
    ...
    seq_len=SEQ_LEN,
    type="streaming",
    tokenizer_path='/datapool/models/Qwen3-235B-A22B',
